...
fn case_read_volatile1(val: i32) -> bool {
    // ValidPtr
    if val > 0 {
        let x = val;
        let p: *const i32 = &x;
...
fn case_read_volatile2(val: i32) -> bool {
    // Aligned
    match val {
        0 => {
            let x = val;
...
fn case_read_volatile3(val: i32) -> bool {
    match val {
        0 => {
            let x = 42u32;
            let p: *const u32 = &x;
...
fn case_read_volatile4(val: i32) -> bool {
    match val {
        0 => {
...
fn main() {
    // let _ = case_read_volatile1(1);
    //let _ = case_read_volatile2(2);
    //let _ = case_read_volatile3(0);
    let _ = case_read_volatile4(0);
}
